    ...
    return (
        ...
        <div className="w-full max-w-md rounded-3xl border border-white/5 bg-brand-surface p-8 shadow-xl">
            ...
            <div className="space-y-2">
                ...
                <a href="#" className="text-xs text-brand-teal hover:underline">Forgot Password?</a>
                </div>
                <input
                type="password"
                required
            ...
            <button
                type="submit"
                className="w-full rounded-xl bg-brand-teal py-3.5 text-sm font-semibold text-brand-dark shadow-lg shadow-brand-teal/10 transition-all hover:opacity-90 active:scale-[0.99]"
            >
                Sign In
            </button>
            </form>
            ...
            <button className="w-full flex items-center justify-center gap-3 rounded-xl bg-brand-dark border border-white/5 py-3 text-sm font-medium text-white hover:bg-white/5 transition-all mb-6">
